...
//                MySearchLine.StartEndLL.add(step.getEntrance().getLocation());
//                MySearchLine.StartEndLL.add(step.getExit().getLocation());
...
//        }
        ...
        //MySearchLine.StartEndLL.add(mRouteLine.getAllStep().get(0).getEntrance().getLocation());
        //MySearchLine.StartEndLL.add(mRouteLine.getAllStep()
        //        .get(mRouteLine.getAllStep().size() - 1).getExit().getLocation());

        if (MySearchLine.tag == 1 && mRouteLine.getStarting() != null) {
            overlayOptionses.add((new MarkerOptions())
        ...
        if (MySearchLine.tag + 1 == MySearchLine.allNum && mRouteLine.getTerminal() != null) {
            overlayOptionses.add((new MarkerOptions())
...
//                    color = Color.argb(178, 88, 208, 0);
                ...
                //MySearchLine.ALLLATLNG.add(step.getWayPoints());
            ...
            //if (tag > 1) {
             ...
             //   List<LatLng> list = new ArrayList<>();
              //  list.add(MySearchLine.StartEndLL.get(tag*2-1));
              //  list.add(MySearchLine.StartEndLL.get(tag*2));

              //  overlayOptionses.add(new PolylineOptions()
               //         .points(list).width(10).color(Color.argb(178, 88, 208, 0)));

//                boolean isUse = true;
//
//                for (List<LatLng> list1 : MySearchLine.ALLLATLNG) {
//                    if (list1.contains(MySearchLine.StartEndLL.get(tag*2-3)) &&
//                            list1.contains(MySearchLine.StartEndLL.get(tag*2-2))) {
//                        isUse = false;
//                        break;
//                    }
//                }
